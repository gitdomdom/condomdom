             ...
             <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        ...
                        <?php 
                        $rssmartphone = mysqli_query($conn,"select id,tensp,image,gia from sanpham where loaisp='smartphone' order by sldaban DESC LIMIT 20");
                       ...
                       <div class="tab-content">
                                    <div class="container">
                                            ...
                                            <div class="row">
                                                <?php while($row = mysqli_fetch_assoc($rssmartphone))
                                                { ?>
                                                <div class="product-item col-md-4 text-center col-sm-6 col-xs-6"  style="margin-top: 30px;
                                                    ...
                                                    <div class="product-thumb">
                                                        <a href="../pages/chitiet.php?id=<?php echo $row['id']; ?>">
                                                            ...
                                                            <img src="../assets/img/product/dienthoai-12.jpg" class="img-sec" alt="" style = "width: 200px;height: 200px">
                                                        </a>
