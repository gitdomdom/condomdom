                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contact-message">
                            <h2>Gửi cho chúng tôi ý kiến của bạn</h2>
                            <form id="contact-form" action="http://demo.hasthemes.com/galio-v6/galio/assets/php/mail.php" method="post" class="contact-form">
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="contact-btn">
                                            <button class="sqr-btn" type="submit">Gửi ý kiến</button> 
                                        </div> 
                                    </div> 
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info mt-md-28 mt-sm-28">
                            <h2>Liên Hệ</h2>
                            <p>Mọi ý kiến của bạn là những gì chúng tôi có thể tiếp thu để phục vụ khách hàng tốt hơn!</p>
                            <ul>
                                <li><i class="fa fa-fax"></i> Địa chỉ: 141 Chiến Thắng, Thanh Trì, Hà Nội</li>
                                <li><i class="fa fa-phone"></i> tranleuy.kma.com</li>
                                <li><i class="fa fa-envelope-o"></i> 0962979942</li>
                            </ul>
