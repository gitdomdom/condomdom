    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($imgUpload['name'])){
            ...
            if(file_exists($target_file))
                $error['imgUpload']="* Ảnh đã tồn tại";
            $f=1;
        }else{
            $f=0;
            $image = $row['image'];
        ...
        if(empty($error)){
            ...
            $sql="UPDATE sanpham SET tensp='$tensp',image='$image',gia=$gia,chitiet='$chitiet',loaisp='$loaisp',hangsx='$hangsx' WHERE id=$id";
            mysqli_query($conn,$sql);
            echo "<script>alert('Cập nhật thành công!');location='index.php';</script>";
        }
    }
?>
<!DOCTYPE html>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active"><a href="edit_sp.php"><i class="ft-edit"></i><span class="menu-title" data-i18n="">Chỉnh sửa</span></a>
          </li>
                ...
                <div class="row">
                    <form action="" method='POST' enctype="multipart/form-data">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="tensp" placeholder="Tên SP..." id="title" value="<?php echo $row['tensp']; ?>"></td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="hangsx" placeholder="Hãng SX..." id="title" value="<?php echo $row['hangsx']; ?>"></td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="gia" placeholder="Giá..." id="title" value="<?php echo $row['gia']; ?>"></td>
                        </tr>
                        <!--  -->
                        <tr>
                            <td><strong>Ảnh Đại Diện:</strong></td>    
                            <td><img src="../assets/img/product/<?php echo $row['image']; ?>" style="width: 100px">
                        ...
                        <tr>
                            ...
                            <td><textarea class="ckeditor" name="chitiet" id="ckeditor" value="<?php echo $row['chitiet']; ?>"><?php echo $row['chitiet']; ?></textarea></td>
                        </tr>
                        <tr>
                            <td></td>
